...
#' @title convert.ffmSpec
#'
#' @description function to convert to current class
#' @param specObj is a ffmSpec object,
#' @param FitObj a fitted object
#' @param RegStatsObj a summary stats
#' @export
...
#' @title print.ffmSpec
#'
#' @description function to print the object
#' @param specObj is a ffmSpec object
#' @export
