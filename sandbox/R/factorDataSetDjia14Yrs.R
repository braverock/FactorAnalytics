#' factorDataSetDjia14Yrs
#'
#' DJIA stocks Compustat factors 14yrs. Data loads lazily
#' 
...
#' @docType data
#'
#' @usage data('factorDataSetDjia14Yrs')
#'
#' @format A data.frame with 2354  observations on 17 variables:
#' \itemize{
...
#' }
#' @source TBA
#' @examples  str(factorDataSetDjia14Yrs)
"factorDataSetDjia14Yrs"